...
use "../use/rpp-data.dta", clear
keep studynum t_teststatisticr t_df1r t_rr t_ro t_n_o_for_tables t_n_r_for_tables t_nr t_no  t_pval_user owithincir
*drop if owithincir==.
...
*** Note:
*** See for example studynum 113 for example of larger replication effect
*** counted as "not within 95% CI.
